...
public class BezeircurveView extends View{  private static final int CIRCLE_SIZE = 10;
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        mPaint.setColor(res.getColor(android.R.color.holo_red_light));
    ...
    private void drawText(String text, int x, int y, Canvas canvas)
    {
        ...
        p.setColor(res.getColor(android.R.color.holo_blue_bright));
